const { save_array, load_rows } = require("../../ev___tools/f_excel");
const { descriptions_parse } = require("../../ev___tools/f_description_parse_regular");
const fs = require("fs");
(async function test() {
    //| загружаем массив данных
    let data_loaded = await load_rows("base_from_avito.xlsx", "sheet1");
    //| Добавим id
...
//# sourceMappingURL=parse_descriptions.js.map