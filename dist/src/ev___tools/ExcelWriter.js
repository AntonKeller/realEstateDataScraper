...
const ExcelWriter = {
    writeInExcel: async (complex_array = [["default"]["default"]], file_name = "defaultFileName", params = { properties: { defaultColWidth: 18 } }) => {
    ...
    writeInExcelX: async (template = defaultTemplate, fileName = "default.xlsx", params = { properties: { defaultColWidth: 18, tabColor: { argb: 'FF00FF00' } } }) => {
        const workbook = new Excel.Workbook();
